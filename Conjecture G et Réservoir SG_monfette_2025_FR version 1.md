...
Ce que nous avons : **𝔖 > 0 — densité asymptotique positive pour toutes les orbites.
**Ce qu'il faut : **∀ 2n, ∃ une paire dans l'orbite — existence ponctuelle garantie.

Ce fossé est le cœur de la conjecture de Goldbach. Il ne peut pas être comblé par des arguments de densité seuls — il requiert un argument de type Chen ou GRH + formule explicite.

| **Étape** | **Objectif** | **Outil requis** | **Portée** |
| --- | --- | --- | --- |
| 1 | Formaliser N_orbit(x)∼𝔖·x/(log x)^k avec borne d'erreur explicite | GEH standard | Publiable |
| 2 | Prouver k_min(N) = O((log N)^{3+ε}) | Nouveau — cœur du problème | Goldbach restreint |
| 3 | Chen-SG : p∈SG(11), q premier ou semi-premier | Crible de Selberg adapté | Plus fort que Chen |
...
- Structure mod 30 — R₀, familles SG, loi p-k

- Conjecture C3 — non-réversibilité orbitale (rapport de Kolmogorov = 9)

- Proposition Goldbach-mod30 — plancher |P(2n)| ≥ 2

- Les 29 orbites — couverture, p_médian, taux p₁, série singulière 𝔖
